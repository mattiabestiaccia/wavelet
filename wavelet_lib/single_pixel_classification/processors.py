...
class PixelClassificationProcessor:
    ...
    def __init__(self, model=None, scattering=None, model_path=None, class_mapping=None, 
                 device=None, patch_size=32, stride=16, J=2):
        """
        ...
        if model_path and (model is None or scattering is None):
        ...
        # Verifica che il modello e la trasformata scattering siano definiti
        if self.model is None or self.scattering is None:
            raise ValueError("È necessario fornire model e scattering o model_path")
