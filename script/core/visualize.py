#!/usr/bin/env python3
"""
Visualization script for Wavelet Scattering Transform models.

This script provides various visualization functions for model results,
training metrics, and dataset analysis.

Usage:
    python script/core/visualize.py metrics --model-dir /path/to/model_output
