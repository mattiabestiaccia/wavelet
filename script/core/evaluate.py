#!/usr/bin/env python3
"""
Evaluation script for Wavelet Scattering Transform models.

This script performs a comprehensive evaluation of a model on a dataset,
providing detailed metrics and visualizations.

Usage:
    python script/core/evaluate.py --model-path /path/to/model.pth --dataset /path/to/dataset [options]
"""
