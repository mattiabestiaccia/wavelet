#!/usr/bin/env python3
"""
Prediction script for Wavelet Scattering Transform classification models.

This script allows for image classification using trained classification models,
supporting both whole-image classification and tile-based analysis.

Usage:
    python script/core/predict_classification.py --model-path /path/to/model.pth --image-path /path/to/image.jpg [options]
    python script/core/predict_classification.py --model-path /path/to/model.pth --image-path /path/to/image.jpg --tile-mode [options]
"""
...
from wavelet_lib.classification import ClassificationProcessor as ImageProcessor
